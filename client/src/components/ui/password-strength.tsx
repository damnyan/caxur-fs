...
export function PasswordStrength({ value = "", isFocused = false }: PasswordStrengthProps) {
  ...
  return (
    ...
    >
      <div className="p-4 rounded-xl border border-primary/10 bg-card/30 backdrop-blur-sm space-y-3 shadow-inner">
          ...
          {[...Array(4)].map((_, index) => (
            <div
              ...
              className={cn(
                ...
                index < filledSegments ? strengthColor : "bg-muted/50"
              )}
            />
          ))}
        </div>
            ...
            >
              ...
              <span
                className={cn(
                  ...
                  criterion.met ? "text-emerald-500 font-medium" : "text-muted-foreground"
                )}
              >
                {criterion.label}
              </span>
